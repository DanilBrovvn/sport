...
const Challenges = () => {
  const challenges = [
    {
      name: 'Гига-Баскетбол',
      description: 'командная игра с гигантским мячом',
      icon: Target,
      color: 'blue-600',
      image: 'https://i.postimg.cc/T1T9hsHC/Whats-App-Image-2025-09-26-at-23-56-56.jpg'
    },
    {
      name: 'Борьба Сумо',
      description: 'веселые поединки в костюмах сумо',
      icon: Zap,
      color: 'orange-600',
      image: 'https://i.postimg.cc/J0RqtFd6/Whats-App-Image-2025-09-27-at-00-10-49.jpg'
    },
    {
      name: 'Кактус',
      description: 'проверка меткости',
      icon: Trophy,
      color: 'green-600',
      image: 'https://i.postimg.cc/BbJgtzwm/Whats-App-Image-2025-09-26-at-23-56-55.jpg'
    },
    {
    ...
    },
    {
      ...
      icon: Heart,
      color: 'indigo-600',
      image: 'https://i.postimg.cc/QCjbVznY/Whats-App-Image-2025-09-27-at-00-05-32.jpg'
    }
  ];
  ...
  return (
    <section id="challenges" className="py-24 bg-black">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        {/* Featured Challenges */}
        <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-10 mb-16">
        ...
        <div className="bg-gradient-to-br from-gray-800 to-gray-900 border-2 border-purple-400/30 rounded-3xl p-10 shadow-2xl">
          <h3 className="text-2xl sm:text-3xl font-black text-transparent bg-clip-text bg-gradient-to-r from-purple-400 to-pink-600 mb-8 text-center">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 mb-8">
            {additionalChallenges.map((challenge, index) => (
              <div key={index} className="flex items-center space-x-4 bg-gradient-to-r from-purple-600/20 to-pink-600/20 border-2 border-purple-400/30 p-6 rounded-xl hover:shadow-lg hover:shadow-purple-500/30 transition-all duration-300 transform hover:-translate-y-2 hover:border-purple-400">
                <div className="w-3 h-3 sm:w-4 sm:h-4 bg-gradient-to-r from-yellow-400 to-red-500 rounded-full flex-shrink-0"></div>
                <span className="text-white font-bold text-base sm:text-lg">{challenge}</span>
              </div>
            ))}
          </div>
          
          <div className="text-center">
            <p className="text-lg sm:text-2xl text-yellow-400 italic font-bold">
